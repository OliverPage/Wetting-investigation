...
"""
for i in range(20):
    wall = np.round(0.2 * i, 1)
    run(Mu,1/Beta,Lx,Ly,epsilon=1.2,epsilon_w=wall,iterMax=Iter,savename="Prob13: βε_w="+str(wall))

for i in range(51):
    It_No = 10 * i
    run(Mu,1/Beta,Lx,Ly,epsilon=1.2,epsilon_w=2/Beta,iterMax=It_No,savename="Prob13: Iterations="+str(It_No))
"""
